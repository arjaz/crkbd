...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    (KC_SCROLLLOCK,    KC_QUOT, KC_COMM,      KC_DOT,       KC_P, KC_Y, KC_F, KC_G, KC_C,         KC_R,         KC_L, KC_NO,
    ...
    (KC_TRNS,          KC_Q, KC_W,       KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I,    KC_O,   KC_P,          KC_LBRC,
     ...
     SCROLL_LOCK_TG_1, KC_Z, KC_X,       KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, RALT(KC_RBRC), KC_TRNS,
